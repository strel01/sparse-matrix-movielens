...
# -*- coding: utf-8 -*-
"""
Экспериментальное сравнение форматов разреженных матриц
Автор: Стрелков Владимир

Графики:
1. Зависимость времени выполнения операций от размера матрицы
2. Зависимость потребления памяти от степени разрежённости
"""
